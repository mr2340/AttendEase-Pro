...
<!-- Mobile Interface: Restricted -->
<div class="mobile-only-layout" style="display: flex; justify-content: center; align-items: center; min-height: 80vh; text-align: center; padding: 40px;">
    <div>
        <div style="width: 80px; height: 80px; background: #fee2e2; color: #ef4444; border-radius: 30px; display: flex; justify-content: center; align-items: center; margin: 0 auto 30px;">
            <i data-lucide="monitor" style="width: 40px; height: 40px;"></i>
        </div>
        <h2 style="font-size: 24px; font-weight: 900; color: #0f172a;">Infrastructure Required</h2>
        <p style="color: #64748b; margin-top: 15px; line-height: 1.6;">The Guardian Infrastructure Manager requires a high-fidelity desktop environment for secure administrative operations.</p>
        <button onclick="window.location.href='../lecturer/dashboard'" class="btn-primary" style="margin-top: 30px;">Return to Dashboard</button>
    </div>
</div>
